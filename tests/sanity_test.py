...
def create_sanity_test_params() -> Iterable[SanityTestParams]:
    return [
        ...
        SanityTestParams("custom_strategies tzinfo", CustomTzInfo(timedelta(hours=1))),
        SanityTestParams("tz aware datetime", datetime(2020, 1, 1, 10, 0, 0, 0, timezone.utc)),
        SanityTestParams("custom_strategies tzinfo datetime", datetime(2020, 1, 1, 10,
                                                                       tzinfo=CustomTzInfo(timedelta(hours=1)))),
        SanityTestParams("custom_strategies object", CustomObject(1)),
